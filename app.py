...
with open("keys/.geminiai_api_key.txt") as f:
    key = f.read()
genai.configure(api_key=key)

st.balloons()
st.title("🗨️🤖AI Conversational Chatbot")
st.title("...Iam CHITTI the robot...")

st.chat_message("ai").write("Hi, How can i help you today?")
